...
export class IncognitonClient {
  ...
  profile = {
     ...
     * @returns Promise<ApiResponse<{ profiles: BrowserProfile[]; status: 'ok' }>> - List of browser profiles
     */
    list: async (): Promise<ApiResponse<{ profiles: BrowserProfile[]; status: 'ok' }>> => {
     ...
     * @returns Promise<ApiResponse<{ profileData: BrowserProfile; status: 'ok' }>> - Profile details
     */
    get: async (
      id: ProfileId
     ...
     * @returns Promise<ApiResponse<{ message: string; status: 'ok' }>> - Launch confirmation
     */
    launch: async (id: ProfileId): Promise<ApiResponse<{ message: string; status: 'ok' }>> => {
      return this.httpAgent
  ...
  cookie = {
     ...
     * @returns Promise<ApiResponse<{ CookieData: GetCookieResponse[]; message: string; status: 'ok' }>> - List of cookies
     */
    get: async (
      profileId: ProfileId
    ): Promise<ApiResponse<{ CookieData: GetCookieResponse[]; message: string; status: 'ok' }>> => {
      return this.httpAgent
     ...
     * @returns Promise<ApiResponse<{ profile_browser_id: string; format: string; cookie: string }>> - Added cookie details
     */
    add: async (
      profileId: ProfileId,
      data: AddCookieRequest
    ): Promise<ApiResponse<{ profile_browser_id: string; format: string; cookie: string }>> => {
      return this.httpAgent
  ...
  automation = {
     ...
     * @param {ProfileId} profileId - Unique identifier of the profile
     * @returns Promise<ApiResponse<{ puppeteerUrl: string; status: 'ok' }>> - Puppeteer connection URL
     */
    launchPuppeteer: async (
      profileId: ProfileId
    ): Promise<ApiResponse<{ puppeteerUrl: string; status: 'ok' }>> => {
      return this.httpAgent
     ...
     * @param {ProfileId} profileId - Unique identifier of the profile
     * @returns Promise<ApiResponse<{ status: 'ok' }>> - Launch confirmation
     */
    launchSelenium: async (profileId: ProfileId): Promise<ApiResponse<{ status: 'ok' }>> => {
      return this.httpAgent
